...
class _RechargePageState extends State<RechargePage> {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            const Text("Combien voulez-vous recharger ?",
            ...
            Row(
              ...
              children:
                  _suggestions.map((amt) => _buildSuggestionChip(amt)).toList(),
            ),
            const SizedBox(height: 35),
            const Text("Moyen de recharge",
                style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
            ...
            const Text("Numéro de débit (+229)",
                style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
            const SizedBox(height: 10),
            TextField(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border:
              Border.all(color: const Color(0xFFB8860B).withValues(alpha: 0.3)),
        ),
        child: Text("${amount}F",
            style: TextStyle(
                color: _amountController.text == amount.toString()
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(15),
          border: Border.all(
              color: isSelected ? const Color(0xFFB8860B) : Colors.black12,
              width: 1.5),
        ),
        child: Row(
          children: [
            Icon(icon,
                color: isSelected ? const Color(0xFFB8860B) : Colors.grey),
  ...
  void _showSuccessMessage() {
    final double montant = double.tryParse(_amountController.text) ?? 0;
      ...
      builder: (context) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 10),
            Text(
              "Veuillez confirmer le retrait de ${montant.toInt()} FCFA sur votre téléphone ($_selectedMethod).",
